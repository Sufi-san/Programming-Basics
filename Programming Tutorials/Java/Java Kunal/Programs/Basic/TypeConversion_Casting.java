...
/* char and boolean exceptions: (tested in Java 11)
    ...
    char can be converted to byte or short but requires typecasting.
    byte, short, int, long, float, double can also be converted to char they too require typecasting.
    ...
    to convert integer to boolean we use logical operators.
    e.g:
    int x = 42;
